    ...
    const embed = new MessageEmbed()
      ...
      .addFields({
        ...
        value: [
          ...
          'Продолжительность конкурса указывается числом и временной переменной например 5m 2h - это 5 минут, 2 часа.',
        ...
        name: '👥 Example:',
        value: [
          `⌨️ ${config["Bot_Info"].prefix}start #general 10m 1 ПЯТЬ ЛЯМ МОНЕТЫ`,
          `➡️ Создает на \`10 minute\` конкурс на \`1\` победителя с призом`,
          `\`ПЯТЬ ЛЯМ МОНЕТЫ\` на канале \`#general\`.`
        ].join('\n')
      }, {
